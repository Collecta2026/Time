...
STRINGS = {
    ...
    # Comments & departmental payroll
    "comment": {"en": "Comment", "ar": "ملاحظة"},
    "comments": {"en": "Comments", "ar": "ملاحظات"},
    "save_comment": {"en": "Save", "ar": "حفظ"},
    "rep_payroll_dept": {"en": "Payroll by department", "ar": "الرواتب حسب الإدارة"},
    "by_department": {"en": "By department", "ar": "حسب الإدارة"},
    "organisation_total": {"en": "Organisation total", "ar": "إجمالي المؤسسة"},
    "select_run": {"en": "Payroll period", "ar": "فترة الرواتب"},
    "employer_cost": {"en": "Employer cost", "ar": "تكلفة صاحب العمل"},
}
